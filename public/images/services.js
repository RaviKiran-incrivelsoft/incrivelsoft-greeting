...
const Services = ({ className = "" }) => {
  return (
    <div
      className={`flex-1 flex flex-row items-end justify-start gap-[52px] max-w-full z-[2] text-left text-13xl text-black font-yeseva-one mq1225:flex-wrap ${className}`}
    >
